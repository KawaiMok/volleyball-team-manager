    ...
    <div className="space-y-6">
      ...
      <div className="border-t border-zinc-100 pt-4">
        ...
        <button
          ...
          className="mt-4 rounded-md border border-zinc-300 dark:border-zinc-600 bg-white dark:bg-zinc-900 px-4 py-2 text-sm font-medium text-zinc-900 dark:text-zinc-50 hover:bg-zinc-50 dark:bg-zinc-950 disabled:opacity-60"
        >
          {pending ? "儲存中…" : "儲存通知設定"}
        </button>
      </div>
