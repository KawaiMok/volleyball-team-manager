    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-600">
          依對方 <strong className="font-medium text-zinc-800">Clerk 登入信箱</strong>{" "}
          建立隊籍；對方首次登入後會與此 Email 合併。正式環境請勿仰賴 Bootstrap。
        </p>
      </div>

      <section className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-zinc-500">隊伍設定</h2>
        <p className="mt-1 text-xs text-zinc-500">隊名、賽季與分組會影響標題列與行事曆／事件篩選。</p>
      ...
      <section className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-zinc-500">新增隊員／隊務</h2>
        <div className="mt-4">
      ...
      <section className="rounded-lg border border-zinc-200 bg-white shadow-sm">
        <div className="border-b border-zinc-100 px-4 py-3">
          <h2 className="text-sm font-semibold uppercase tracking-wide text-zinc-500">目前名單</h2>
          <p className="mt-1 text-xs text-zinc-500">點「編輯」於大視窗修改資料；手機由下往上滑出面板，可按 ×、背景或 Esc 關閉。</p>
        </div>
        <TeamRosterSection
          key={teamSettingsKey}
          squads={squads}
